...
module.exports = {
    data: new SlashCommandBuilder()
        .setName(`calculator`)
        .setDescription(`Calculator embed will be replyed.`),
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            .setColor("Blue")
            .setDescription("```\n Resulst will be displayed here\n```")
        ...
        collector.on('collect', async i => {
            ...
            if(value === "=") {
                try {
                    ...
                    data = "";
                    extra = "An error happend please reset the Calculator with pressing \** AC \**"
                }
            } else if(value === "clear") {
                data = "";
                extra = "Result will display here"
