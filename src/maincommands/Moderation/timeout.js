...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(!interaction.member.permissions.has(PermissionsBitField.Flags.ManageRoles)) return await interaction.reply({ content: `You don't have permission to timeout members`, ephemeral: true})
